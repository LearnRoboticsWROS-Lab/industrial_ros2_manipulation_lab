"""Module 3 target: launch the UR5 + Robotiq + depth camera workcell.

The simulation cell under study — Gazebo with the full cell and RViz with the MoveIt planning
