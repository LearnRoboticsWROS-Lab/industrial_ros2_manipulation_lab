...
def generate_launch_description():
    ...
    # --- share dirs ---
    uryt_share     = get_package_share_directory("lrwros_ur5_workcell")
    ...
    world_file = os.path.join(get_package_share_directory('lrwros_ur5_workcell'), 'worlds', 'pick_place_workplace.world')
    ...
    # --- MoveIt config ---
    joint_controllers_file = os.path.join(uryt_share, "config", "ur5_gripper_controllers.yaml")
    moveit_config = (
    ...
    rviz_cfg = os.path.join(get_package_share_directory("lrwros_ur5_moveit_config"),
                            "config", "moveit.rviz")
    rviz = Node(
